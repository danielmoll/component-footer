    ...
    return array.map(function (item) {
      ...
      if (item.internal === false) {
        return _react2['default'].createElement(
          'a',
          _extends({ className: 'ec-footer__link ec-footer__link--external'
  ...
  Footer.prototype.render = function render() {
    ...
    if (this.props.quote) {
      ...
      quote = _react2['default'].createElement(
        ...
        _react2['default'].createElement('p', { className: 'ec-footer__quote-paragraph', dangerouslySetInnerHTML: dangerousInnerHTML })
      );
    }
